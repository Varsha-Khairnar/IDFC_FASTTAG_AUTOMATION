...
public class Dshboard_quik_Recharge {
	WebDriver driver;
	...
	@Test
public void Dashboard_quick_Recharge() throws InterruptedException {
	Thread.sleep(3000);
	...
	driver.findElement(By.xpath("//div[contains(text(),'Quick Recharge')]")).click();
}
